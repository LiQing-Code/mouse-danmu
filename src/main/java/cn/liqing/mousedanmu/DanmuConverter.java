...
public class DanmuConverter {
        ...
        var mutableText = Text.literal(user.name)
                ...
                .styled(style -> style
                        ...
                        .withClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL,
                                "https://space.bilibili.com/%s".formatted(user.uid)))
                        .withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT,
                                Text.translatable("text.mousedanmu.click-to-user-space"))));
    ...
    public MutableText convert(@NotNull Emoji emoji) {
        var mutableText = Texts.bracketed(Text.literal(emoji.body))
                .styled(style -> style.withColor(config.danmu.emojiColor)
                        ...
                        .withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT,
                                Text.translatable("text.mousedanmu.click-to-view-emoji"))));
    ...
    public MutableText convert(@NotNull Interactive interactive) {
        var msg = switch (interactive.type) {
            case 1 -> Text.translatable("text.mousedanmu.entry-live-room");
            case 2 -> Text.translatable("text.mousedanmu.attention-live-room");
            case 3 -> Text.translatable("text.mousedanmu.share-live-room");
            case 4 -> Text.translatable("text.mousedanmu.special-attention-live-room");
            case 5 -> Text.translatable("text.mousedanmu.mutual-attention-live-room");
